                      ...
                      <td>
                        <div class="dropdown" style="display: flex;">
                            ...
                            <a style="width: 20%; border-radius: 1.3em;color: rgb(132, 122, 5); font-weight: 500;" class="dropdown-item" href="bookingdetail&bookingid=${booking.id}"><i class="bx bx-edit-alt me-1"></i>
                              ...
                              <a style="width: 20%; border-radius: 1.3em; padding-right: 5em; color: rgb(221, 75, 75);" class="dropdown-item" href="#deletebooking${booking.id}"
                                                                                  class="trigger-btn" data-toggle="modal"><i class="bx bx-trash me-1"></i>Cancel</a>
                              </c:if>
                                    ...
                                    <div class="modal-dialog modal-confirm">
                                      <div class="modal-content">
                                        <div class="modal-header flex-column">
                                          ...
                                          <h4 class="modal-title w-100">Cancel Booking?</h4>
