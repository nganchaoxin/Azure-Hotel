    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            ...
            <div class="layout-page">
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                    ...
                                    <div class="avatar avatar-online">
                                        <img src='<c:url value="/resources/static/assets/img/avatars/1.png" />' alt
                                        ...
                                        <a class="dropdown-item" href="#">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 me-3">
                                                    <div class="avatar avatar-online">
                                                        <img src='<c:url value="/resources/static/assets/img/avatars/1.png" />'
                ...
                <!-- Content wrapper -->
                <div class="content-wrapper" style="display: flex; padding-top: 4em; justify-items: center; align-items: center;"
>
                    <!-- Content -->
                    ...
                    <div class="card text-center" style="width: 350px;">
                        ...
                        <div class="card-body px-5">
                            ...
                            <div class="form-outline">
                                ...
                                <input type="text" id="typeEmail" name="email" class="form-control my-3" placeholder="Enter your email"/>
                            </div>
                            <button type="submit" class="btn btn-primary w-100" style="margin-top: .5em;" >Reset password</button>
                            </form>
                        </div>
                    </div>
                    </c:if>
                    <c:if test="${page.equals('changePassword')}">
                        <div class="card text-center" style="width: 350px;">
                            ...
                            <div class="card-body px-5">
                                ...
                                <div class="form-outline">
                                    <label class="form-label" for="typeEmail">Email input</label>
                                    <input type="password" id="typeEmail" name="password" class="form-control my-3" placeholder="Enter new password"/>
                                    <input type="password" id="typeEmail" name="password_two" class="form-control my-3" placeholder="Confirm password"/>
                                </div>
