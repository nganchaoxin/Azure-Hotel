            ...
            <div class="navbar-nav align-items-center pt-2">
              ...
              <sec:authorize access="isAuthenticated()">
                <sec:authorize access="hasRole('ROLE_USER')">
                  <a class="nav-link d-flex align-items-center " style="color:
                  white" href="<c:url
                    value="
                  /bookingcart"
                  />">My Cart
          ...
          <div class="room-card">
            <div class="row">
              ...
              <div class="col-6 py-4">
                <div class="card-body">
                  <h1>${availableRoomList[0].categoryEntity.category_name}</h1>
                  <div class="room-info">
            ...
            <ul class="pagination justify-content-center">
              <c:if test="${currentPage > 0}">
                <li class="page-item">
                  <a
                    class="page-link"
                    href="?checkin=${param.checkin}&checkout=${param.checkout}&roomType=${param.roomType}&guests=${param.guests}&page=${currentPage - 1}"
                    >&laquo;</a
                  >
                </li>
              </c:if>
              <c:forEach begin="0" end="${totalPages - 1}" var="i">
                <li class="page-item ${currentPage == i ? 'active' : ''}">
                  <a
                    class="page-link"
                    href="?checkin=${param.checkin}&checkout=${param.checkout}&roomType=${param.roomType}&guests=${param.guests}&page=${i}"
                    >${i + 1}</a
                  >
                </li>
              </c:forEach>
